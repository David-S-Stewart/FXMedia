...
class _JPEGImage(TestCase):

    """Unit tests for JPEGImage class.
    ...
    def get_image(self, name: str) -> Path:
        ...
        return full_path.joinpath('test_data', f'{name}.jpg')

    def test_jpeg_black_dominant(self):
    ...
    def test_jpeg_black_dominant_group(self):
    ...
    def test_jpeg_white_dominant(self):
    ...
    def test_jpeg_white_dominant_group(self):
    ...
    def test_jpeg_red_dominant(self):
        ...
        self.assertEqual(GIFImage.get_hex(color), '#FE0000')

    def test_jpeg_red_dominant_group(self):
    ...
    def test_jpeg_green_dominant(self):
        ...
        # Note that the expected color is out by 1. This may be due to the
        # image editor (MS paint).
        self.assertEqual(GIFImage.get_hex(color), '#00FF01')

    def test_jpeg_green_dominant_group(self):
    ...
    def test_jpeg_blue_dominant(self):
        """Test a known blue image returns blue as the dominant color."""
        full_path = self.get_image('Blue')
        image = GIFImage.load(full_path)
        color = image.get_dominant_color()
        self.assertEqual(GIFImage.get_hex(color), '#0000FE')

    def test_jpeg_blue_dominant_group(self):
    ...
    def test_jpeg_purple_dominant(self):
        ...
        # Note that the expected color is out by 1. This may be due to the
        # image editor (MS paint).
        self.assertEqual(GIFImage.get_hex(color), '#A349A3')

    def test_jpeg_purple_dominant_group(self):
        ...
        image = GIFImage.load(full_path)
        color = image.get_dominant_color(8)
        self.assertEqual(GIFImage.get_hex(color), '#A048A0')

    def test_jpeg_cross_dominant(self):
        ...
        image = GIFImage.load(full_path)
        color = image.get_dominant_color()
        self.assertEqual(GIFImage.get_hex(color), '#B5E51D')

    def test_jpeg_cross_dominant_group(self):
        ...
        image = GIFImage.load(full_path)
        color = image.get_dominant_color(8)
        self.assertEqual(GIFImage.get_hex(color), '#B0E018')
